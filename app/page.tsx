        ...
        <div id="ai-insights-section" className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-2xl mb-8 border border-purple-200 dark:border-purple-900">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            ...
            <div className="flex items-center gap-3">
              <span id="ai-daily-limit" className="text-xs text-gray-500 dark:text-gray-400"><span id="ai-requests-remaining">0</span>/<span id="ai-daily-limit-value">5</span> daily requests</span>
          ...
          <div id="ai-cooldown-bar" className="hidden mb-4"><div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400"><span id="ai-cooldown-text">Please wait...</span><div className="flex-1 h-2 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden"><div id="ai-cooldown-progress" className="h-full bg-purple-500 transition-all duration-1000" style={{ width: "100%" }}></div></div></div></div>
          <div id="ai-limit-reached" className="hidden p-4 bg-amber-50 dark:bg-amber-900/30 border border-amber-200 dark:border-amber-800 rounded-lg"><div className="flex items-center gap-3"><svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-amber-600" viewBox="0 0 20 20" fill="currentColor"><path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" /></svg><span className="text-sm text-amber-800 dark:text-amber-200">Daily limit reached. Come back tomorrow!</span></div></div>
